...
- Optionale Intake-Presets: `intake-authoring-governance` v0.2.0 prio 64, `intake-review-governance` v0.1.1 prio 65 und `intake-sequencing-governance` v0.1.0 prio 66 bleiben ausserhalb der Standard-Achtermatrix. Das neue Elf-Preset-Profil fuegt Sequencing ausdruecklich hinzu; bestehende Neun-/Zehn-Profile bleiben kompatibel. Neue registrierte Flotten-Repositories erben `defaultPresetProfile`. *Optional intake presets at priorities 64, 65, and 66 remain outside the standard eight. The separate eleven-preset profile adds sequencing explicitly while existing nine- and ten-preset profiles remain compatible.*
