...
- Die vier Agenten-CLI-Oberflaechen `codex`, `claude`, `gemini` und `gh copilot` sind Required. `codex` und fehlende Linux-/Windows-`gemini`-CLIs werden ueber npm gepflegt; `claude` und `gh copilot` bleiben paketmanagerbasiert.
