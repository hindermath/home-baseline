...
- Standard-Preset-Set: `security-governance` v0.4.0 prio 10, `architecture-governance` v0.2.0 prio 20, `isaqb-architecture-governance` v0.1.0 prio 30, `a11y-governance` v0.3.0 prio 40, `cross-platform-governance` v0.1.0 prio 50, `agent-parity-governance` v0.2.0 prio 60.
- `a11y-governance` v0.3.0 ergaenzt didaktische Inline-Code-Kommentar-Governance fuer neue oder geaenderte nicht-triviale Logik.
