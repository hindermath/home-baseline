...
- Neue MSL-Level-2-Projekte installieren bei der Spec-Kit-Initialisierung standardmäßig die Presets aus `scripts/config/spec-kit-governance-presets.json`; C#/.NET- und Lern-Level-2-Projekte verwenden standardmäßig alle acht Presets, sofern keine begründete Ausnahme dokumentiert ist.
