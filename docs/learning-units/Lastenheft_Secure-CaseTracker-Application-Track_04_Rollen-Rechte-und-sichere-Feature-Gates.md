# Lastenheft: Secure CaseTracker Application Track 04 - Rollen, Rechte und sichere Feature-Gates
...
<!-- lf-konkret -->
**DE:** Konkrete Lernfelder (Quelle: `Rahmenlehrplan-Lernfeld-Mapping.md`): **primär LF 11a („Funktionalität in Anwendungen realisieren")**; berührt LF 4 („Schutzbedarfsanalyse im eigenen Arbeitsbereich durchführen"). Vertiefte Erklärung und Verständnisfragen: `lernbegleiter/Secure-CaseTracker-Application-Track_04_Rollen-Rechte-und-sichere-Feature-Gates.Lernbegleiter.md`.

**EN:** Concrete learning fields (source: `Rahmenlehrplan-Lernfeld-Mapping.md`): **primary LF 11a ("Funktionalität in Anwendungen realisieren")**; touched LF 4 ("Schutzbedarfsanalyse im eigenen Arbeitsbereich durchführen"). Deeper explanation and comprehension questions: `lernbegleiter/Secure-CaseTracker-Application-Track_04_Rollen-Rechte-und-sichere-Feature-Gates.Lernbegleiter.md`.
...
**DE:** Erarbeite für sichere Feature-Gates und eine Rechteprüfung eine fokussierte Spezifikation für die Spezialisierung AE - Anwendungsentwicklung. Berücksichtige: Feature-Zugriff, Rollen, Rechte, sichere Defaults und Missbrauchsfälle werden geprüft.
...
- Erwartete Evidenz: Rechtematrix, Feature-Gate-Regeln, Missbrauchsfälle, Reviewpfad.
...
```text
/speckit-specify Nutze docs/learning-units/Lastenheft_Secure-CaseTracker-Application-Track_04_Rollen-Rechte-und-sichere-Feature-Gates.md als verbindliche Eingabedatei. Erstelle eine fokussierte Feature-Spezifikation für sichere Feature-Gates und eine Rechteprüfung der EuFPA-Lernreihe Secure CaseTracker Application Track. Erzeuge keine Implementierung und starte keinen Sammellauf für die gesamte Lernreihe.
```
