# Lastenheft: Secure InventoryHub 07 - Patch-, Wartungs- und Risikoansicht
...
**DE:** Patchstand, Wartungstermine, veraltete Software, Risikoklassen und Aussagegrenzen werden sichtbar.
...
<!-- lf-konkret -->
**DE:** Konkrete Lernfelder (Quelle: `Rahmenlehrplan-Lernfeld-Mapping.md`): **primär LF 6 („Serviceanfragen bearbeiten")**; berührt LF 4 („Schutzbedarfsanalyse im eigenen Arbeitsbereich durchführen"). Vertiefte Erklärung und Verständnisfragen: `lernbegleiter/Secure-InventoryHub_07_Patch-Wartungs-und-Risikoansicht.Lernbegleiter.md`.

**EN:** Concrete learning fields (source: `Rahmenlehrplan-Lernfeld-Mapping.md`): **primary LF 6 ("Serviceanfragen bearbeiten")**; touched LF 4 ("Schutzbedarfsanalyse im eigenen Arbeitsbereich durchführen"). Deeper explanation and comprehension questions: `lernbegleiter/Secure-InventoryHub_07_Patch-Wartungs-und-Risikoansicht.Lernbegleiter.md`.
...
**DE:** Erarbeite für eine einfache Patch-, Wartungs- und Risikoansicht eine fokussierte Spezifikation. Berücksichtige: Patchstand, Wartungstermine, veraltete Software, Risikoklassen und Aussagegrenzen werden sichtbar.
...
- Erwartete Evidenz: Risikomatrix, Patchstatus, Aussagegrenzen, Open-Punkte.
...
```text
/speckit-specify Nutze docs/learning-units/Lastenheft_Secure-InventoryHub_07_Patch-Wartungs-und-Risikoansicht.md als verbindliche Eingabedatei. Erstelle eine fokussierte Feature-Spezifikation für eine einfache Patch-, Wartungs- und Risikoansicht der EuFPA-Lernreihe Secure InventoryHub. Erzeuge keine Implementierung und starte keinen Sammellauf für die gesamte Lernreihe.
```
