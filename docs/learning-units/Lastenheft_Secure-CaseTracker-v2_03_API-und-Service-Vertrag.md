# Lastenheft: Secure CaseTracker v2 03 - API- und Service-Vertrag
...
**DE:** Operationen, Eingaben, Ausgaben, Fehlerfälle, Validierung und Netzwerkgrenzen werden vertraglich beschrieben.
...
<!-- lf-konkret -->
**DE:** Konkrete Lernfelder (Quelle: `Rahmenlehrplan-Lernfeld-Mapping.md`): **primär LF 8 („Daten systemübergreifend bereitstellen")**; berührt LF 6 („Serviceanfragen bearbeiten"). Vertiefte Erklärung und Verständnisfragen: `lernbegleiter/Secure-CaseTracker-v2_03_API-und-Service-Vertrag.Lernbegleiter.md`.

**EN:** Concrete learning fields (source: `Rahmenlehrplan-Lernfeld-Mapping.md`): **primary LF 8 ("Daten systemübergreifend bereitstellen")**; touched LF 6 ("Serviceanfragen bearbeiten"). Deeper explanation and comprehension questions: `lernbegleiter/Secure-CaseTracker-v2_03_API-und-Service-Vertrag.Lernbegleiter.md`.
...
**DE:** Erarbeite für einen nachvollziehbaren Service- oder API-Vertrag eine fokussierte Spezifikation. Berücksichtige: Operationen, Eingaben, Ausgaben, Fehlerfälle, Validierung und Netzwerkgrenzen werden vertraglich beschrieben.
...
- Erwartete Evidenz: Endpoint-/Operationenliste, Validierungsregeln, Fehlervertrag, ASVS-N/A-Prüfung.
...
```text
/speckit-specify Nutze docs/learning-units/Lastenheft_Secure-CaseTracker-v2_03_API-und-Service-Vertrag.md als verbindliche Eingabedatei. Erstelle eine fokussierte Feature-Spezifikation für einen nachvollziehbaren Service- oder API-Vertrag der EuFPA-Lernreihe Secure CaseTracker v2. Erzeuge keine Implementierung und starte keinen Sammellauf für die gesamte Lernreihe.
```
