# Lastenheft: Secure InventoryHub 09 - Teststrategie, Sandbox und Betriebsnachweise
...
**DE:** Fachliche Tests, negative Sicherheitstests, Testdaten, Sandbox, CI und Betriebsnachweise werden verbunden.
...
<!-- lf-konkret -->
**DE:** Konkrete Lernfelder (Quelle: `Rahmenlehrplan-Lernfeld-Mapping.md`): **primär LF 6 („Serviceanfragen bearbeiten")**; berührt LF 9 („Netzwerke und Dienste bereitstellen"). Vertiefte Erklärung und Verständnisfragen: `lernbegleiter/Secure-InventoryHub_09_Teststrategie-Sandbox-und-Betriebsnachweise.Lernbegleiter.md`.

**EN:** Concrete learning fields (source: `Rahmenlehrplan-Lernfeld-Mapping.md`): **primary LF 6 ("Serviceanfragen bearbeiten")**; touched LF 9 ("Netzwerke und Dienste bereitstellen"). Deeper explanation and comprehension questions: `lernbegleiter/Secure-InventoryHub_09_Teststrategie-Sandbox-und-Betriebsnachweise.Lernbegleiter.md`.
...
- **Checklisten:** CL_01, CL_02, CL_07, CL_08, CL_09, CL_11.
...
**DE:** Erarbeite für eine Test-, Sandbox- und Betriebsnachweisstrategie eine fokussierte Spezifikation. Berücksichtige: Fachliche Tests, negative Sicherheitstests, Testdaten, Sandbox, CI und Betriebsnachweise werden verbunden.
...
- Erwartete Evidenz: Testmatrix, Sandbox-Regeln, CI-Nachweise, Betriebsannahmen.
...
```text
/speckit-specify Nutze docs/learning-units/Lastenheft_Secure-InventoryHub_09_Teststrategie-Sandbox-und-Betriebsnachweise.md als verbindliche Eingabedatei. Erstelle eine fokussierte Feature-Spezifikation für eine Test-, Sandbox- und Betriebsnachweisstrategie der EuFPA-Lernreihe Secure InventoryHub. Erzeuge keine Implementierung und starte keinen Sammellauf für die gesamte Lernreihe.
```
