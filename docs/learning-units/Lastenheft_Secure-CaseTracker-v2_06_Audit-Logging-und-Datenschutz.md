# Lastenheft: Secure CaseTracker v2 06 - Audit-Logging und Datenschutz
...
**DE:** Audit-Events, erlaubte Logfelder, verbotene Logfelder, Aufbewahrung und Datenschutzgrenzen werden festgelegt.
...
<!-- lf-konkret -->
**DE:** Konkrete Lernfelder (Quelle: `Rahmenlehrplan-Lernfeld-Mapping.md`): **primär LF 4 („Schutzbedarfsanalyse im eigenen Arbeitsbereich durchführen")**; berührt LF 5 („Software zur Verwaltung von Daten anpassen"). Vertiefte Erklärung und Verständnisfragen: `lernbegleiter/Secure-CaseTracker-v2_06_Audit-Logging-und-Datenschutz.Lernbegleiter.md`.

**EN:** Concrete learning fields (source: `Rahmenlehrplan-Lernfeld-Mapping.md`): **primary LF 4 ("Schutzbedarfsanalyse im eigenen Arbeitsbereich durchführen")**; touched LF 5 ("Software zur Verwaltung von Daten anpassen"). Deeper explanation and comprehension questions: `lernbegleiter/Secure-CaseTracker-v2_06_Audit-Logging-und-Datenschutz.Lernbegleiter.md`.
...
**DE:** Erarbeite für ein datenschutzbewusstes Audit-Logging-Konzept eine fokussierte Spezifikation. Berücksichtige: Audit-Events, erlaubte Logfelder, verbotene Logfelder, Aufbewahrung und Datenschutzgrenzen werden festgelegt.
...
- Erwartete Evidenz: Audit-Event-Matrix, Datenminimierung, Aufbewahrungsannahmen, N/A-Begründungen.
...
```text
/speckit-specify Nutze docs/learning-units/Lastenheft_Secure-CaseTracker-v2_06_Audit-Logging-und-Datenschutz.md als verbindliche Eingabedatei. Erstelle eine fokussierte Feature-Spezifikation für ein datenschutzbewusstes Audit-Logging-Konzept der EuFPA-Lernreihe Secure CaseTracker v2. Erzeuge keine Implementierung und starte keinen Sammellauf für die gesamte Lernreihe.
```
