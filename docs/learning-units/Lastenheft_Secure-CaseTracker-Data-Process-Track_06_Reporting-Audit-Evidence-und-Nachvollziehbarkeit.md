# Lastenheft: Secure CaseTracker Data & Process Track 06 - Reporting, Audit-Evidence und Nachvollziehbarkeit
...
<!-- lf-konkret -->
**DE:** Konkrete Lernfelder (Quelle: `Rahmenlehrplan-Lernfeld-Mapping.md`): **primär LF 12c („Kundenspezifische Prozess- und Datenanalyse durchführen")**; berührt LF 6 („Serviceanfragen bearbeiten"). Vertiefte Erklärung und Verständnisfragen: `lernbegleiter/Secure-CaseTracker-Data-Process-Track_06_Reporting-Audit-Evidence-und-Nachvollziehbarkeit.Lernbegleiter.md`.

**EN:** Concrete learning fields (source: `Rahmenlehrplan-Lernfeld-Mapping.md`): **primary LF 12c ("Kundenspezifische Prozess- und Datenanalyse durchführen")**; touched LF 6 ("Serviceanfragen bearbeiten"). Deeper explanation and comprehension questions: `lernbegleiter/Secure-CaseTracker-Data-Process-Track_06_Reporting-Audit-Evidence-und-Nachvollziehbarkeit.Lernbegleiter.md`.
...
**DE:** Erarbeite für ein Reporting- und Audit-Evidence-Konzept eine fokussierte Spezifikation für die Spezialisierung DPA - Daten- und Prozessanalyse. Berücksichtige: Reports, Evidenzpfade, Reproduzierbarkeit, Zugriffsschutz und Nachvollziehbarkeit werden spezifiziert.
...
- Erwartete Evidenz: Reportstruktur, Evidenzpfade, Zugriffsschutz, Reproduzierbarkeitsnachweis.
...
```text
/speckit-specify Nutze docs/learning-units/Lastenheft_Secure-CaseTracker-Data-Process-Track_06_Reporting-Audit-Evidence-und-Nachvollziehbarkeit.md als verbindliche Eingabedatei. Erstelle eine fokussierte Feature-Spezifikation für ein Reporting- und Audit-Evidence-Konzept der EuFPA-Lernreihe Secure CaseTracker Data & Process Track. Erzeuge keine Implementierung und starte keinen Sammellauf für die gesamte Lernreihe.
```
