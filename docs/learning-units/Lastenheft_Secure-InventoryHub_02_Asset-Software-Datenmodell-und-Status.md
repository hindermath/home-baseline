# Lastenheft: Secure InventoryHub 02 - Asset- und Software-Datenmodell und Status
...
**DE:** Assets, Softwarestände, Versionen, Verantwortliche, Statuswerte und Datenqualitätsregeln werden modelliert.
...
<!-- lf-konkret -->
**DE:** Konkrete Lernfelder (Quelle: `Rahmenlehrplan-Lernfeld-Mapping.md`): **primär LF 5 („Software zur Verwaltung von Daten anpassen")**; berührt LF 4 („Schutzbedarfsanalyse im eigenen Arbeitsbereich durchführen"). Vertiefte Erklärung und Verständnisfragen: `lernbegleiter/Secure-InventoryHub_02_Asset-Software-Datenmodell-und-Status.Lernbegleiter.md`.

**EN:** Concrete learning fields (source: `Rahmenlehrplan-Lernfeld-Mapping.md`): **primary LF 5 ("Software zur Verwaltung von Daten anpassen")**; touched LF 4 ("Schutzbedarfsanalyse im eigenen Arbeitsbereich durchführen"). Deeper explanation and comprehension questions: `lernbegleiter/Secure-InventoryHub_02_Asset-Software-Datenmodell-und-Status.Lernbegleiter.md`.
...
- **Checklisten:** CL_01, CL_02, CL_04, CL_08.
...
**DE:** Erarbeite für ein Datenmodell für Assets, Software und Status eine fokussierte Spezifikation. Berücksichtige: Assets, Softwarestände, Versionen, Verantwortliche, Statuswerte und Datenqualitätsregeln werden modelliert.
...
- Erwartete Evidenz: Datenmodell, Statusmatrix, Pflichtfelder, Datenqualitätsregeln.
...
```text
/speckit-specify Nutze docs/learning-units/Lastenheft_Secure-InventoryHub_02_Asset-Software-Datenmodell-und-Status.md als verbindliche Eingabedatei. Erstelle eine fokussierte Feature-Spezifikation für ein Datenmodell für Assets, Software und Status der EuFPA-Lernreihe Secure InventoryHub. Erzeuge keine Implementierung und starte keinen Sammellauf für die gesamte Lernreihe.
```
