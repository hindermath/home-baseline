# Secure ServiceHarvester Professional Tracks Lernreihe / Learning Series
...
**DE:** Diese Datei beschreibt die **Professional Tracks (3. Lehrjahr)** der Familie **Secure ServiceHarvester**. Sie führen die [Basis-Reihe (Jahr 1)](Secure-ServiceHarvester-Lernreihe.md) und die [v2-Reihe (Jahr 2)](Secure-ServiceHarvester-v2-Lernreihe.md) fort und trennen die Arbeit nach Fachrichtung.

**EN:** This file describes the **Professional Tracks (year 3)** of the **Secure ServiceHarvester** family. They continue the [base series (year 1)](Secure-ServiceHarvester-Lernreihe.md) and the [v2 series (year 2)](Secure-ServiceHarvester-v2-Lernreihe.md) and separate the work by specialization.

## Zielbild / Target Picture

**DE:** Die Professional Tracks führen `Secure ServiceHarvester` im 3. Lehrjahr fort. Der gemeinsame fachliche Kern bleibt erhalten, aber die Lernenden spezialisieren sich sichtbar auf AE, SI, DPA oder DV. Das Arbeiten mit KI-Agenten und Spec Kit wird ab Jahr 3 mit stärkeren Trade-off-Begründungen, Review-Nachweisen und Abschlussbewertungen verlangt.

**EN:** The Professional Tracks continue `Secure ServiceHarvester` in the third training year. The shared domain stays the same, but learners specialize visibly into Application Development, System Integration, Data and Process Analysis, or Digital Networking. From year 3, working with AI agents and Spec Kit requires stronger trade-off reasoning, review evidence, and final assessments.

## Track-Übersicht / Track Overview

| Track | Lernreihe | Spezialisierung | Schwerpunkt |
|---|---|---|---|
| AE | [Secure ServiceHarvester Application Track](Secure-ServiceHarvester-Application-Track-Lernreihe.md) | AE – Anwendungsentwicklung | Feature-/API-Entwicklung, Persistenz-Adapter, Viewer/TUI, Tests und wartbare Erweiterbarkeit |
| SI | [Secure ServiceHarvester Operations Track](Secure-ServiceHarvester-Operations-Track-Lernreihe.md) | SI – Systemintegration | Dienst-Härtung, Deployment, CI/CD, Observability, Recovery und Betriebsnachweise |
| DPA | [Secure ServiceHarvester Data & Process Track](Secure-ServiceHarvester-Data-Process-Track-Lernreihe.md) | DPA – Daten- und Prozessanalyse | Datenqualität, Kennzahlen, Reporting, Aussagegrenzen und Datenschutz |
| DV | [Secure ServiceHarvester Digital Networking Track](Secure-ServiceHarvester-Digital-Networking-Track-Lernreihe.md) | DV – Digitale Vernetzung | Maschinen-/Netzbezüge, Schnittstellen, Kommunikationsflüsse, Segmentierung und Verfügbarkeit |
...
- Richtlinie Sichere Entwicklung, 12 Einzel-Checklisten, Checklistensammelband, mitgeltende Dokumente und acht Governance-Presets werden als lokale Nachweisbasis erwartet.
...
**DE:** Jahr 1 vermittelt Grundlagen und einfache Nachweise. Jahr 2 vertieft Architektur, Hosting, Persistenz, Schnittstellen, Tests und Betrieb. Jahr 3 trennt die Arbeit nach Spezialisierung und verlangt stärkere Trade-off-Begründungen, Review-Nachweise und Abschlussbewertungen.

**EN:** Year 1 teaches foundations and simple evidence. Year 2 deepens architecture, hosting, persistence, interfaces, tests, and operation. Year 3 separates the work by specialization and requires stronger trade-off reasoning, review evidence, and final assessments.
