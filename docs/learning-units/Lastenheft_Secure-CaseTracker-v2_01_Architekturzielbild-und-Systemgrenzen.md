# Lastenheft: Secure CaseTracker v2 01 - Architekturzielbild und Systemgrenzen
...
**DE:** Systemkontext, Trust Boundaries, Komponenten, ADR-Kandidaten und Schutzbedarf werden sichtbar.
...
<!-- lf-konkret -->
**DE:** Konkrete Lernfelder (Quelle: `Rahmenlehrplan-Lernfeld-Mapping.md`): **primär LF 5 („Software zur Verwaltung von Daten anpassen")**; berührt LF 8 („Daten systemübergreifend bereitstellen"). Vertiefte Erklärung und Verständnisfragen: `lernbegleiter/Secure-CaseTracker-v2_01_Architekturzielbild-und-Systemgrenzen.Lernbegleiter.md`.

**EN:** Concrete learning fields (source: `Rahmenlehrplan-Lernfeld-Mapping.md`): **primary LF 5 ("Software zur Verwaltung von Daten anpassen")**; touched LF 8 ("Daten systemübergreifend bereitstellen"). Deeper explanation and comprehension questions: `lernbegleiter/Secure-CaseTracker-v2_01_Architekturzielbild-und-Systemgrenzen.Lernbegleiter.md`.
...
**DE:** Erarbeite für ein sprachneutrales Architekturzielbild für die Service Edition eine fokussierte Spezifikation. Berücksichtige: Systemkontext, Trust Boundaries, Komponenten, ADR-Kandidaten und Schutzbedarf werden sichtbar.
...
- Erwartete Evidenz: Systemkontext, Trust-Boundary-Liste, ADR-Kandidaten, N/A-Matrix.
...
```text
/speckit-specify Nutze docs/learning-units/Lastenheft_Secure-CaseTracker-v2_01_Architekturzielbild-und-Systemgrenzen.md als verbindliche Eingabedatei. Erstelle eine fokussierte Feature-Spezifikation für ein sprachneutrales Architekturzielbild für die Service Edition der EuFPA-Lernreihe Secure CaseTracker v2. Erzeuge keine Implementierung und starte keinen Sammellauf für die gesamte Lernreihe.
```
