# Lastenheft: Secure CaseTracker Application Track 10 - Abschlussreview mit Restrisiken und Übergabe
...
<!-- lf-konkret -->
**DE:** Konkrete Lernfelder (Quelle: `Rahmenlehrplan-Lernfeld-Mapping.md`): **primär LF 12a („Kundenspezifische Anwendungsentwicklung durchführen")**; berührt LF 5 („Software zur Verwaltung von Daten anpassen"). Vertiefte Erklärung und Verständnisfragen: `lernbegleiter/Secure-CaseTracker-Application-Track_10_Abschlussreview-mit-Restrisiken-und-Uebergabe.Lernbegleiter.md`.

**EN:** Concrete learning fields (source: `Rahmenlehrplan-Lernfeld-Mapping.md`): **primary LF 12a ("Kundenspezifische Anwendungsentwicklung durchführen")**; touched LF 5 ("Software zur Verwaltung von Daten anpassen"). Deeper explanation and comprehension questions: `lernbegleiter/Secure-CaseTracker-Application-Track_10_Abschlussreview-mit-Restrisiken-und-Uebergabe.Lernbegleiter.md`.
...
**DE:** Erarbeite für ein fachliches und technisches Abschlussreview eine fokussierte Spezifikation für die Spezialisierung AE - Anwendungsentwicklung. Berücksichtige: Ergebnisse, Restrisiken, offene Punkte, Testnachweise und Übergabeempfehlung werden zusammengeführt.
...
- Erwartete Evidenz: Reviewbericht, Restrisiken, Folgeaufgaben, Übergabenotiz.
...
```text
/speckit-specify Nutze docs/learning-units/Lastenheft_Secure-CaseTracker-Application-Track_10_Abschlussreview-mit-Restrisiken-und-Uebergabe.md als verbindliche Eingabedatei. Erstelle eine fokussierte Feature-Spezifikation für ein fachliches und technisches Abschlussreview der EuFPA-Lernreihe Secure CaseTracker Application Track. Erzeuge keine Implementierung und starte keinen Sammellauf für die gesamte Lernreihe.
```
