# Secure ServiceHarvester Data & Process Track Lernreihe / Data & Process Track Learning Series

**Stand / Date:** 2026-07-06
**Übungsfirma / Training company:** EuFPA – Europäische Firma Programmiert Alles
**Zielgruppe / Audience:** Fachinformatiker*innen der Fachrichtung Daten- und Prozessanalyse ab dem 3. Lehrjahr / IT specialists in Data and Process Analysis from the third training year onward
**Zielsprachen / Target languages:** C#, Go, Java, Python, Rust, Swift
**Ausrichtung / Orientation:** DE-first, EN-second, CEFR B2, WCAG 2.2 AA

## Einordnung / Placement

**DE:** Dieser Track ist die DPA-Spezialisierung der [Professional Tracks (Jahr 3)](Secure-ServiceHarvester-Professional-Tracks-Lernreihe.md) der Familie Secure ServiceHarvester. Er baut auf [v2 (Jahr 2)](Secure-ServiceHarvester-v2-Lernreihe.md) auf.

**EN:** This track is the Data and Process Analysis specialization of the [Professional Tracks (year 3)](Secure-ServiceHarvester-Professional-Tracks-Lernreihe.md) of the Secure ServiceHarvester family. It builds on [v2 (year 2)](Secure-ServiceHarvester-v2-Lernreihe.md).

## Zielbild / Target Picture

**DE:** Der Data & Process Track vertieft den verantwortlichen Umgang mit den gesammelten Daten: Datenqualität, aussagekräftige Kennzahlen, Reporting, Datenschutz und die ehrliche Benennung von Aussagegrenzen. Im Mittelpunkt stehen belastbare Auswertungen und die Frage, was die Daten wirklich aussagen können und was nicht.

**EN:** The Data & Process Track deepens the responsible handling of the collected data: data quality, meaningful metrics, reporting, privacy, and the honest naming of interpretation limits. The focus is robust evaluation and the question of what the data can and cannot really say.
...
| 02 | Datenqualität im Harvester |
| 03 | Kennzahlen und Betriebsmetriken |
