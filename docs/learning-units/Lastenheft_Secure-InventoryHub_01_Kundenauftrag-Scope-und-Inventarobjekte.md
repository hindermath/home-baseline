# Lastenheft: Secure InventoryHub 01 - Kundenauftrag, Scope und Inventarobjekte
...
**DE:** Kundenauftrag, Inventarobjekte, Nicht-Ziele, Schutzbedarf und erste Nachweispfade werden geklärt.
...
<!-- lf-konkret -->
**DE:** Konkrete Lernfelder (Quelle: `Rahmenlehrplan-Lernfeld-Mapping.md`): **primär LF 1 („Das Unternehmen und die eigene Rolle im Betrieb beschreiben")**; berührt LF 6 („Serviceanfragen bearbeiten"). Vertiefte Erklärung und Verständnisfragen: `lernbegleiter/Secure-InventoryHub_01_Kundenauftrag-Scope-und-Inventarobjekte.Lernbegleiter.md`.

**EN:** Concrete learning fields (source: `Rahmenlehrplan-Lernfeld-Mapping.md`): **primary LF 1 ("Das Unternehmen und die eigene Rolle im Betrieb beschreiben")**; touched LF 6 ("Serviceanfragen bearbeiten"). Deeper explanation and comprehension questions: `lernbegleiter/Secure-InventoryHub_01_Kundenauftrag-Scope-und-Inventarobjekte.Lernbegleiter.md`.
...
**DE:** Erarbeite für einen klaren Scope für den Secure InventoryHub eine fokussierte Spezifikation. Berücksichtige: Kundenauftrag, Inventarobjekte, Nicht-Ziele, Schutzbedarf und erste Nachweispfade werden geklärt.
...
- Erwartete Evidenz: Scope-Tabelle, Inventarobjekte, Nicht-Ziele, Schutzbedarf, N/A-Matrix.
...
```text
/speckit-specify Nutze docs/learning-units/Lastenheft_Secure-InventoryHub_01_Kundenauftrag-Scope-und-Inventarobjekte.md als verbindliche Eingabedatei. Erstelle eine fokussierte Feature-Spezifikation für einen klaren Scope für den Secure InventoryHub der EuFPA-Lernreihe Secure InventoryHub. Erzeuge keine Implementierung und starte keinen Sammellauf für die gesamte Lernreihe.
```
