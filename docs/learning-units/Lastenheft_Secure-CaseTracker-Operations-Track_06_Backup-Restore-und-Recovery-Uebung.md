# Lastenheft: Secure CaseTracker Operations Track 06 - Backup, Restore und Recovery-Übung
...
<!-- lf-konkret -->
**DE:** Konkrete Lernfelder (Quelle: `Rahmenlehrplan-Lernfeld-Mapping.md`): **primär LF 11b („Betrieb und Sicherheit vernetzter Systeme gewährleisten")**; berührt LF 9 („Netzwerke und Dienste bereitstellen"). Vertiefte Erklärung und Verständnisfragen: `lernbegleiter/Secure-CaseTracker-Operations-Track_06_Backup-Restore-und-Recovery-Uebung.Lernbegleiter.md`.

**EN:** Concrete learning fields (source: `Rahmenlehrplan-Lernfeld-Mapping.md`): **primary LF 11b ("Betrieb und Sicherheit vernetzter Systeme gewährleisten")**; touched LF 9 ("Netzwerke und Dienste bereitstellen"). Deeper explanation and comprehension questions: `lernbegleiter/Secure-CaseTracker-Operations-Track_06_Backup-Restore-und-Recovery-Uebung.Lernbegleiter.md`.
...
**DE:** Erarbeite für ein Backup-, Restore- und Recovery-Konzept eine fokussierte Spezifikation für die Spezialisierung SI - Systemintegration. Berücksichtige: Backup-Ziele, Restore-Ablauf, Recovery-Test, Datenverlustgrenzen und Nachweise werden geplant.
...
- Erwartete Evidenz: Backup-Regeln, Restore-Testplan, Recovery-Nachweis, Restrisiken.
...
```text
/speckit-specify Nutze docs/learning-units/Lastenheft_Secure-CaseTracker-Operations-Track_06_Backup-Restore-und-Recovery-Uebung.md als verbindliche Eingabedatei. Erstelle eine fokussierte Feature-Spezifikation für ein Backup-, Restore- und Recovery-Konzept der EuFPA-Lernreihe Secure CaseTracker Operations Track. Erzeuge keine Implementierung und starte keinen Sammellauf für die gesamte Lernreihe.
```
