...
acht Governance-Presets nachzuweisen und die lokale Secure-Development-Basis zu prüfen – ohne Fachlogik
vorwegzunehmen.
...
finishing none cleanly. **Starting an AI agent directly on the workstation instead of inside the container.**
