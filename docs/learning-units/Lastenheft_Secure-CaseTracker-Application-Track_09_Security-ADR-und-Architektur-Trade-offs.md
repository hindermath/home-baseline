# Lastenheft: Secure CaseTracker Application Track 09 - Security-ADR und Architektur-Trade-offs
...
**DE:** Sicherheitsrelevante Architekturentscheidungen werden als ADR mit Alternativen, Trade-offs und Evidenz dokumentiert.
...
|---|---|---|
| AE | hoch (primär) | Welche sicherheitsrelevante Architekturentscheidung war ein Trade-off und wie ist sie als ADR begründet? |
| SI | mittel | Welche Betriebs- oder Deployment-Auswirkung hat die Architekturentscheidung? |
| DPA | mittel | Welche Datenschutz- oder Datenqualitätswirkung hat die Entscheidung? |
| DV | mittel | Welche Schnittstellen- oder Systemgrenze wird durch die Architekturentscheidung geprägt? |
...
<!-- lf-konkret -->
**DE:** Konkrete Lernfelder (Quelle: `Rahmenlehrplan-Lernfeld-Mapping.md`): **primär LF 12a („Kundenspezifische Anwendungsentwicklung durchführen")**; berührt LF 4 („Schutzbedarfsanalyse im eigenen Arbeitsbereich durchführen"). Vertiefte Erklärung und Verständnisfragen: `lernbegleiter/Secure-CaseTracker-Application-Track_09_Security-ADR-und-Architektur-Trade-offs.Lernbegleiter.md`.

**EN:** Concrete learning fields (source: `Rahmenlehrplan-Lernfeld-Mapping.md`): **primary LF 12a ("Kundenspezifische Anwendungsentwicklung durchführen")**; touched LF 4 ("Schutzbedarfsanalyse im eigenen Arbeitsbereich durchführen"). Deeper explanation and comprehension questions: `lernbegleiter/Secure-CaseTracker-Application-Track_09_Security-ADR-und-Architektur-Trade-offs.Lernbegleiter.md`.
...
**DE:** Erarbeite für Security-ADRs für die wichtigsten Architekturentscheidungen eine fokussierte Spezifikation für die Spezialisierung AE - Anwendungsentwicklung. Berücksichtige: Sicherheitsrelevante Architekturentscheidungen werden als ADR mit Alternativen, Trade-offs und Evidenz dokumentiert.
...
- ADR-Inhalt, Alternativen und Trade-off-Bewertung bleiben für C#, Go, Java, Python, Rust und Swift vergleichbar.
...
- Erwartete Evidenz: ADR-Entwürfe, Alternativen, Trade-offs, Restrisiken.
...
```text
/speckit-specify Nutze docs/learning-units/Lastenheft_Secure-CaseTracker-Application-Track_09_Security-ADR-und-Architektur-Trade-offs.md als verbindliche Eingabedatei. Erstelle eine fokussierte Feature-Spezifikation für Security-ADRs für die wichtigsten Architekturentscheidungen der EuFPA-Lernreihe Secure CaseTracker Application Track. Erzeuge keine Implementierung und starte keinen Sammellauf für die gesamte Lernreihe.
```
