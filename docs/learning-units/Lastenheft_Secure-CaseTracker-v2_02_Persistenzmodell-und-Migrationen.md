# Lastenheft: Secure CaseTracker v2 02 - Persistenzmodell und Migrationen
...
**DE:** Entitäten, Beziehungen, Pflichtfelder, Migrationen, Datenminimierung und Rollback-Annahmen werden geplant.
...
<!-- lf-konkret -->
**DE:** Konkrete Lernfelder (Quelle: `Rahmenlehrplan-Lernfeld-Mapping.md`): **primär LF 5 („Software zur Verwaltung von Daten anpassen")**; berührt LF 8 („Daten systemübergreifend bereitstellen"). Vertiefte Erklärung und Verständnisfragen: `lernbegleiter/Secure-CaseTracker-v2_02_Persistenzmodell-und-Migrationen.Lernbegleiter.md`.

**EN:** Concrete learning fields (source: `Rahmenlehrplan-Lernfeld-Mapping.md`): **primary LF 5 ("Software zur Verwaltung von Daten anpassen")**; touched LF 8 ("Daten systemübergreifend bereitstellen"). Deeper explanation and comprehension questions: `lernbegleiter/Secure-CaseTracker-v2_02_Persistenzmodell-und-Migrationen.Lernbegleiter.md`.
...
**DE:** Erarbeite für ein persistentes Datenmodell mit migrationsfähigen Regeln eine fokussierte Spezifikation. Berücksichtige: Entitäten, Beziehungen, Pflichtfelder, Migrationen, Datenminimierung und Rollback-Annahmen werden geplant.
...
- Erwartete Evidenz: Datenmodell, Migrationsannahmen, Testdatenregeln, Datenschutzbegründung.
