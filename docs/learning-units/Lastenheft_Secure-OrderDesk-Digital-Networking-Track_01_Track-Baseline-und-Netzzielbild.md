# Lastenheft: Secure OrderDesk Digital Networking Track 01 - Track-Baseline und Netzzielbild
...
**DE:** Die Track-Baseline aus Jahr 2 (v2) wird festgehalten und in ein **Netzzielbild** der Bestell-Pipeline von Secure Trader übersetzt: Schutzziele des Netzes, das Szenario der verteilten Bestellverarbeitung, grobe Vertrauenszonen, Verfügbarkeitsziele sowie Scope und Nicht-Ziele des DV-Tracks. Lernende trennen das fachliche Bestell-Ziel klar vom vernetzten Betriebsziel.

**EN:** The track baseline from year 2 (v2) is recorded and translated into a **network target picture** of Secure Trader's order pipeline: network protection goals, the distributed order-processing scenario, coarse trust zones, availability targets, and the scope and non-goals of the Digital Networking Track. Learners separate the functional ordering goal clearly from the networked operational goal.

## Fachrichtungsbezug / Specialization Fit

| Fachrichtung | Eignung | Reflexionsfrage |
|---|---|---|
| DV | Schwerpunkt | Welches Netz-Schutzziel und welche Vertrauenszone entscheiden über die spätere Architektur der Bestell-Pipeline? |
...
| DPA | mittel | Welche Datenklasse oder Datenschutzgrenze wird durch die verteilte Bestellverarbeitung berührt? |
...
<!-- lf-konkret -->
**DE:** Konkrete Lernfelder (Quelle: `Rahmenlehrplan-Lernfeld-Mapping.md`): **primär LF 11d („Betrieb und Sicherheit vernetzter Systeme gewährleisten")**; berührt LF 10d („Cyber-physische Systeme entwickeln"), LF 12d („Kundenspezifisches cyber-physisches System optimieren") und LF 9 („Netzwerke und Dienste bereitstellen"). Vertiefte Erklärung und Verständnisfragen: `lernbegleiter/Secure-OrderDesk-Digital-Networking-Track_01_Track-Baseline-und-Netzzielbild.Lernbegleiter.md`.

**EN:** Concrete learning fields (source: `Rahmenlehrplan-Lernfeld-Mapping.md`): **primary LF 11d ("Betrieb und Sicherheit vernetzter Systeme gewährleisten")**; touched LF 10d ("Cyber-physische Systeme entwickeln"), LF 12d ("Kundenspezifisches cyber-physisches System optimieren"), and LF 9 ("Netzwerke und Dienste bereitstellen"). Deeper explanation and comprehension questions: `lernbegleiter/Secure-OrderDesk-Digital-Networking-Track_01_Track-Baseline-und-Netzzielbild.Lernbegleiter.md`.
...
- **R-01:** Der v2-Ausgangsstand und das Netzzielbild der Bestell-Pipeline sind klar beschrieben und voneinander getrennt.
...
- Netzgrenzen, Bestellannahme, Katalog, relationale Ablage, Konfiguration, Logs und Abhängigkeiten als mögliche Vertrauensgrenzen prüfen.
