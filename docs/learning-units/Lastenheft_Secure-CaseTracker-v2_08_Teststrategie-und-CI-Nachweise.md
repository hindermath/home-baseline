# Lastenheft: Secure CaseTracker v2 08 - Teststrategie und CI-Nachweise
...
**DE:** Fachliche Tests, Sicherheitstests, Datenschutztests, CI-Annahmen, Testdaten und Nachweispfade werden festgelegt.
...
<!-- lf-konkret -->
**DE:** Konkrete Lernfelder (Quelle: `Rahmenlehrplan-Lernfeld-Mapping.md`): **primär LF 6 („Serviceanfragen bearbeiten")**; berührt LF 5 („Software zur Verwaltung von Daten anpassen"). Vertiefte Erklärung und Verständnisfragen: `lernbegleiter/Secure-CaseTracker-v2_08_Teststrategie-und-CI-Nachweise.Lernbegleiter.md`.

**EN:** Concrete learning fields (source: `Rahmenlehrplan-Lernfeld-Mapping.md`): **primary LF 6 ("Serviceanfragen bearbeiten")**; touched LF 5 ("Software zur Verwaltung von Daten anpassen"). Deeper explanation and comprehension questions: `lernbegleiter/Secure-CaseTracker-v2_08_Teststrategie-und-CI-Nachweise.Lernbegleiter.md`.
...
**DE:** Erarbeite für eine prüfbare Test- und CI-Strategie eine fokussierte Spezifikation. Berücksichtige: Fachliche Tests, Sicherheitstests, Datenschutztests, CI-Annahmen, Testdaten und Nachweispfade werden festgelegt.
...
- Erwartete Evidenz: Testmatrix, CI-Nachweispfade, Testdatenregeln, Open-Punkte.
...
```text
/speckit-specify Nutze docs/learning-units/Lastenheft_Secure-CaseTracker-v2_08_Teststrategie-und-CI-Nachweise.md als verbindliche Eingabedatei. Erstelle eine fokussierte Feature-Spezifikation für eine prüfbare Test- und CI-Strategie der EuFPA-Lernreihe Secure CaseTracker v2. Erzeuge keine Implementierung und starte keinen Sammellauf für die gesamte Lernreihe.
```
