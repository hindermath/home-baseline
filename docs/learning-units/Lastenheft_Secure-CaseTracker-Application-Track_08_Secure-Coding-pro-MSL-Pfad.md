# Lastenheft: Secure CaseTracker Application Track 08 - Secure Coding pro MSL-Pfad
...
<!-- lf-konkret -->
**DE:** Konkrete Lernfelder (Quelle: `Rahmenlehrplan-Lernfeld-Mapping.md`): **primär LF 11a („Funktionalität in Anwendungen realisieren")**; berührt LF 4 („Schutzbedarfsanalyse im eigenen Arbeitsbereich durchführen"). Vertiefte Erklärung und Verständnisfragen: `lernbegleiter/Secure-CaseTracker-Application-Track_08_Secure-Coding-pro-MSL-Pfad.Lernbegleiter.md`.

**EN:** Concrete learning fields (source: `Rahmenlehrplan-Lernfeld-Mapping.md`): **primary LF 11a ("Funktionalität in Anwendungen realisieren")**; touched LF 4 ("Schutzbedarfsanalyse im eigenen Arbeitsbereich durchführen"). Deeper explanation and comprehension questions: `lernbegleiter/Secure-CaseTracker-Application-Track_08_Secure-Coding-pro-MSL-Pfad.Lernbegleiter.md`.
...
- **Checklisten:** CL_01, CL_03, CL_06, CL_08, CL_12.
...
**DE:** Erarbeite für einen sprachspezifischen Secure-Coding-Abgleich eine fokussierte Spezifikation für die Spezialisierung AE - Anwendungsentwicklung. Berücksichtige: Sprachspezifische Secure-Coding-Regeln für C#, Go, Java, Python, Rust und Swift werden sichtbar gemacht.
...
- Erwartete Evidenz: MSL-Vergleich, Secure-Coding-Matrix, Dependency-Prüfung, N/A-Begründungen.
...
```text
/speckit-specify Nutze docs/learning-units/Lastenheft_Secure-CaseTracker-Application-Track_08_Secure-Coding-pro-MSL-Pfad.md als verbindliche Eingabedatei. Erstelle eine fokussierte Feature-Spezifikation für einen sprachspezifischen Secure-Coding-Abgleich der EuFPA-Lernreihe Secure CaseTracker Application Track. Erzeuge keine Implementierung und starte keinen Sammellauf für die gesamte Lernreihe.
```
