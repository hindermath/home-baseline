# Lastenheft: Secure CaseTracker v2 07 - Import- und Export-Härtung
...
**DE:** Dateiformate, Größenlimits, Pfadprüfung, sichere Deserialisierung, Datenminimierung und negative Tests werden beschrieben.
...
<!-- lf-konkret -->
**DE:** Konkrete Lernfelder (Quelle: `Rahmenlehrplan-Lernfeld-Mapping.md`): **primär LF 8 („Daten systemübergreifend bereitstellen")**; berührt LF 4 („Schutzbedarfsanalyse im eigenen Arbeitsbereich durchführen"). Vertiefte Erklärung und Verständnisfragen: `lernbegleiter/Secure-CaseTracker-v2_07_Import-und-Export-Haertung.Lernbegleiter.md`.

**EN:** Concrete learning fields (source: `Rahmenlehrplan-Lernfeld-Mapping.md`): **primary LF 8 ("Daten systemübergreifend bereitstellen")**; touched LF 4 ("Schutzbedarfsanalyse im eigenen Arbeitsbereich durchführen"). Deeper explanation and comprehension questions: `lernbegleiter/Secure-CaseTracker-v2_07_Import-und-Export-Haertung.Lernbegleiter.md`.
...
**DE:** Erarbeite für eine sichere Import-/Export-Spezifikation eine fokussierte Spezifikation. Berücksichtige: Dateiformate, Größenlimits, Pfadprüfung, sichere Deserialisierung, Datenminimierung und negative Tests werden beschrieben.
...
- Erwartete Evidenz: Dateivertrag, Größenlimits, Pfadregeln, Negativtests, Datenschutzprüfung.
...
```text
/speckit-specify Nutze docs/learning-units/Lastenheft_Secure-CaseTracker-v2_07_Import-und-Export-Haertung.md als verbindliche Eingabedatei. Erstelle eine fokussierte Feature-Spezifikation für eine sichere Import-/Export-Spezifikation der EuFPA-Lernreihe Secure CaseTracker v2. Erzeuge keine Implementierung und starte keinen Sammellauf für die gesamte Lernreihe.
```
