# Lastenheft: Secure CaseTracker Operations Track 07 - Incident Response und Betriebsdokumentation
...
<!-- lf-konkret -->
**DE:** Konkrete Lernfelder (Quelle: `Rahmenlehrplan-Lernfeld-Mapping.md`): **primär LF 11b („Betrieb und Sicherheit vernetzter Systeme gewährleisten")**; berührt LF 4 („Schutzbedarfsanalyse im eigenen Arbeitsbereich durchführen"). Vertiefte Erklärung und Verständnisfragen: `lernbegleiter/Secure-CaseTracker-Operations-Track_07_Incident-Response-und-Betriebsdokumentation.Lernbegleiter.md`.

**EN:** Concrete learning fields (source: `Rahmenlehrplan-Lernfeld-Mapping.md`): **primary LF 11b ("Betrieb und Sicherheit vernetzter Systeme gewährleisten")**; touched LF 4 ("Schutzbedarfsanalyse im eigenen Arbeitsbereich durchführen"). Deeper explanation and comprehension questions: `lernbegleiter/Secure-CaseTracker-Operations-Track_07_Incident-Response-und-Betriebsdokumentation.Lernbegleiter.md`.
...
**DE:** Erarbeite für eine Incident-Response- und Betriebsdokumentation eine fokussierte Spezifikation für die Spezialisierung SI - Systemintegration. Berücksichtige: Meldewege, Rollen, Erstmaßnahmen, Nachweise, Lessons Learned und Betriebsdokumentation werden strukturiert.
...
- Erwartete Evidenz: Incident-Ablauf, Rollenmatrix, Nachweisorte, Lessons-Learned-Vorlage.
...
```text
/speckit-specify Nutze docs/learning-units/Lastenheft_Secure-CaseTracker-Operations-Track_07_Incident-Response-und-Betriebsdokumentation.md als verbindliche Eingabedatei. Erstelle eine fokussierte Feature-Spezifikation für eine Incident-Response- und Betriebsdokumentation der EuFPA-Lernreihe Secure CaseTracker Operations Track. Erzeuge keine Implementierung und starte keinen Sammellauf für die gesamte Lernreihe.
```
