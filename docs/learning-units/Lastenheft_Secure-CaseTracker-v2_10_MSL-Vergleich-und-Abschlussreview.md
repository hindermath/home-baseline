# Lastenheft: Secure CaseTracker v2 10 - MSL-Vergleich und Abschlussreview
...
**DE:** Vergleichskriterien, offene Risiken, akzeptierte Restrisiken, Folgeaufgaben und eine Übergabenotiz werden erstellt.
...
<!-- lf-konkret -->
**DE:** Konkrete Lernfelder (Quelle: `Rahmenlehrplan-Lernfeld-Mapping.md`): **primär LF 6 („Serviceanfragen bearbeiten")**; berührt LF 5 („Software zur Verwaltung von Daten anpassen"). Vertiefte Erklärung und Verständnisfragen: `lernbegleiter/Secure-CaseTracker-v2_10_MSL-Vergleich-und-Abschlussreview.Lernbegleiter.md`.

**EN:** Concrete learning fields (source: `Rahmenlehrplan-Lernfeld-Mapping.md`): **primary LF 6 ("Serviceanfragen bearbeiten")**; touched LF 5 ("Software zur Verwaltung von Daten anpassen"). Deeper explanation and comprehension questions: `lernbegleiter/Secure-CaseTracker-v2_10_MSL-Vergleich-und-Abschlussreview.Lernbegleiter.md`.
...
**DE:** Erarbeite für einen sprachneutralen Abschlussvergleich der sechs MSL-Pfade eine fokussierte Spezifikation. Berücksichtige: Vergleichskriterien, offene Risiken, akzeptierte Restrisiken, Folgeaufgaben und eine Übergabenotiz werden erstellt.
...
- Erwartete Evidenz: Vergleichsmatrix, Restrisiken, Folgeaufgaben, Abschlussbewertung.
