# Lastenheft: Secure CaseTracker Data & Process Track 02 - Datenmodell für Kennzahlen und Auswertungen
...
**DE:** Kennzahlenmodell, Aggregationen, Zeitbezug, Filter und Verantwortlichkeiten werden definiert.
...
|---|---|---|
| DPA | hoch (Schwerpunkt) | Welche Kennzahl, welche Bezugsmenge und welcher Zeitbezug bestimmen das Datenmodell? |
| AE | mittel | Welche Datenstruktur, Aggregations- oder Filterlogik folgt aus dem Kennzahlenmodell? |
| SI | mittel | Welche Betriebs- oder Zeitbasis-Annahme beeinflusst Aggregation und Aktualität? |
| DV | mittel | Welche Schnittstelle liefert die für die Kennzahlen benötigten Rohdaten? |
...
<!-- lf-konkret -->
**DE:** Konkrete Lernfelder (Quelle: `Rahmenlehrplan-Lernfeld-Mapping.md`): **primär LF 11c („Prozesse analysieren und gestalten")**; berührt LF 5 („Software zur Verwaltung von Daten anpassen"). Vertiefte Erklärung und Verständnisfragen: `lernbegleiter/Secure-CaseTracker-Data-Process-Track_02_Datenmodell-fuer-Kennzahlen-und-Auswertungen.Lernbegleiter.md`.

**EN:** Concrete learning fields (source: `Rahmenlehrplan-Lernfeld-Mapping.md`): **primary LF 11c ("Prozesse analysieren und gestalten")**; touched LF 5 ("Software zur Verwaltung von Daten anpassen"). Deeper explanation and comprehension questions: `lernbegleiter/Secure-CaseTracker-Data-Process-Track_02_Datenmodell-fuer-Kennzahlen-und-Auswertungen.Lernbegleiter.md`.
...
**DE:** Erarbeite für ein Kennzahlen- und Auswertungsdatenmodell eine fokussierte Spezifikation für die Spezialisierung DPA - Daten- und Prozessanalyse. Berücksichtige: Kennzahlenmodell, Aggregationen, Zeitbezug, Filter und Verantwortlichkeiten werden definiert.
...
- Kennzahlenmodell, Aggregationen, Zeitbezug und Filter bleiben für C#, Go, Java, Python, Rust und Swift vergleichbar.
- Sprachspezifische Bibliotheken für Aggregation oder Zeitlogik dürfen gewählt werden, müssen aber begründet werden.
...
- Erwartete Evidenz: Kennzahlenmodell, Aggregationsregeln, Filterregeln, Verantwortlichkeiten.
...
```text
/speckit-specify Nutze docs/learning-units/Lastenheft_Secure-CaseTracker-Data-Process-Track_02_Datenmodell-fuer-Kennzahlen-und-Auswertungen.md als verbindliche Eingabedatei. Erstelle eine fokussierte Feature-Spezifikation für ein Kennzahlen- und Auswertungsdatenmodell der EuFPA-Lernreihe Secure CaseTracker Data & Process Track. Erzeuge keine Implementierung und starte keinen Sammellauf für die gesamte Lernreihe.
```
