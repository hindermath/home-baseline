...
| Expected Windows drift exit handling | Corrected before merge | GitHub PowerShell fail-fast intercepted native exit `1`; `Start-Process` now exposes it to the explicit contract assertion |
