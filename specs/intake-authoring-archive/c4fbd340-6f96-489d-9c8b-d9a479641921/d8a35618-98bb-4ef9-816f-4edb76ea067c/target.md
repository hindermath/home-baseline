...
**Version:** 1.0
**Stand:** 2026-08-31
**Reihenfolge:** sichtbare Position 39, aktiver Manifestplatz 34, `Pending`
**Bindende Vorgänger:** keine
**Beratender Vorgänger:** Position 38 über `PreferredSerialOrder`, `binding: false`
...
*This intake defines a later, non-urgent documentation and renderer
harmonization across seven passion-project repositories. Their human-readable
intake order views will link intake files, show direct dependencies, and point
...
- `IAD002`: Das Lastenheft steht sichtbar auf Position 39, bleibt `Pending`
  und erhält nur eine beratende Kante von Position 38.
...
Dieser Intake steht sichtbar auf Position 39 und als aktiver Manifestplatz 34
am Ende der aktuellen Home-Baseline-Reihe. Die Kante von Position 38 ist
`PreferredSerialOrder` und nicht bindend. Position 39 bleibt `Pending` und wird
nicht zum deklarierten bevorzugten `Eligible`-Kandidaten. Diese Einordnung
