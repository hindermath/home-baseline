...
| G4 (`Eligible`) | `Lastenheft_Flottenweite-GitHub-Copilot-Review-Governance-und-Kostenbegrenzung.md` | Reduziert nach abgeschlossenem G3 und Stage B automatische Copilot-Reviews auf acht Repositories und ein Lite-Review ohne Draft-/Push-Wiederholung. / After completed G3 and Stage B, limits automatic Copilot review to eight repositories and one Lite review without draft/push repetition. |
