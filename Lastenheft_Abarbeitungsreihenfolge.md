...
the existing mapping of twelve checklists, 157 review points, 15 related
   ...
   subsequent G3/G4 cost-governance insertion. The closeout started neither item
   7 nor remediation.*
...
als Supersession-Vorstand archiviert und wurde danach durch G3 und G4 erweitert.
...
the superseded predecessor and was then extended by G3 and G4.*

## Abgeschlossene Kosten-Gates / Completed Cost Gates
...
abgeschlossen. G4 wurde als Feature 031 ueber die PRs #260, #261 und #262 sowie
den terminalen Abschluss-Commit `3f17f878` abgeschlossen. Es begrenzt
automatische GitHub-Copilot-Reviews auf acht benannte Public-Repositories und
genau ein Lite-Review pro qualifizierendem Pull Request. Der G4-Knoten und
seine bindende Kante zu Position 7 sind deshalb aus der aktiven Serie entfernt;
Position 39 bleibt der einzige bevorzugte `Eligible`-Kandidat.
...
subsequent Stage B fleet rollout through PRs #258 and #259 are complete. G4
completed as Feature 031 through PRs #260, #261, and #262 plus terminal
completion commit `3f17f878`. It limits automatic Copilot review to eight named
public repositories and one Lite review per qualifying pull request. The G4
node and its binding edge to item 7 have therefore been removed from the active
series; item 39 remains the sole preferred `Eligible` candidate.*

```text
G3 Actions-Budget und Stage B [abgeschlossen / completed]
G4 Copilot-Review-Governance [abgeschlossen / completed, archiviert / archived]
39 Verlinkte Abarbeitungsreihenfolgen [Eligible, vorgezogen / promoted]
  - - [PreferredSerialOrder, nicht bindend / advisory] - ->
7 Container-Haertung [Pending]
```
...
| G4 (abgeschlossen / completed, archiviert / archived) | `Lastenheft_Flottenweite-GitHub-Copilot-Review-Governance-und-Kostenbegrenzung.031-github-copilot-review-governance.md` | Feature 031, PRs #260 bis #262 und Abschluss-Commit `3f17f878` begrenzen automatische Copilot-Reviews auf acht Repositories und ein Lite-Review ohne Draft-/Push-Wiederholung. / Feature 031, PRs #260 through #262, and completion commit `3f17f878` limit automatic Copilot reviews to eight repositories and one Lite review without draft/push repetition. |
| 7 (`Pending`, beratend nach Position 39 / advisory after item 39) | `Lastenheft_Secure-Development-Container-Hardening.md` | Leitet Anforderungen fuer einen sicheren Entwicklungscontainer ab. Das bindende G4-Gate ist abgeschlossen; nur die sichtbare serielle Einordnung hinter Position 39 bleibt. / Derives requirements for a secure development container. Its binding G4 gate is complete; only its visible serial position after item 39 remains. |
...
G3-/Stage-B- und G4-Abschluss 33 Ziele, drei Roots und 37 Abhängigkeiten und deklariert
...
after G3, Stage B, and G4 completion and declares item 39 as the sole preferred Eligible
...
G3 Actions-Budget und Stage B [abgeschlossen / completed]
G4 Copilot-Review [abgeschlossen / completed, archiviert / archived]
39 Verlinkte Abarbeitungsreihenfolgen [Eligible]
  - - [PreferredSerialOrder, nicht bindend / advisory] - ->
7 Container-Haertung [Pending] --> 8 Level-2-Sandbox
9 CI/CD [Root]
...
Die Positionen 7, 38 und 39 besitzen keinen unvollständigen bindenden
...
Delivery-Autorität; die Positionen 7 und 38 bleiben `Pending`.

*Items 7, 38, and 39 have no incomplete binding predecessor and may therefore
...
authority; items 7 and 38 remain Pending.*
...
Der abgeschlossene G3-/Stage-B-Strang gab G4 zunaechst als Root frei. Die
Umbuchung ersetzte G4 durch Position 39 als `Primary`-Root. Nach dem belegten
G4-Abschluss bleiben Position 39 sowie die Positionen 9 und 10 die drei
Manifest-Roots. Position 7 ist fachlich nicht mehr blockiert, bleibt aber durch
die beratende Kante hinter Position 39 als `Pending` eingeordnet.
...
diesen Vorstand und setzte G3 vor G4 sowie G4 vor Position 7. Der G3-Closeout
archivierte G3 samt Stage-B-Nachweis, entfernte die abgeschlossene
G3-zu-G4-Kante und machte G4 zunaechst zum einzigen bevorzugten
`Eligible`-Kandidaten. Die anschliessende Umbuchung verschob Position 39 an den
Anfang der aktiven Serie und machte sie zum einzigen bevorzugten
`Eligible`-Kandidaten. Feature 031 und die PRs #260 bis #262 schlossen G4
danach nachweislich ab. Der aktuelle Seriennachfolger archiviert G4, entfernt
seine bindende Kante zu Position 7 und fuehrt die beratende Kante von Position
39 direkt zu Position 7. Diese Einordnung erteilt keine Start- oder
...
Actions-Budget-Grundlage fuer G4; das abgeschlossene G4 lieferte die
...
is archived. Item 5 completed as Feature 024 and is archived. Item 6 completed
   ...
   G3/G4 update replaced root 7 with G3 and blocked G4 and item 7. The G3
   closeout archived completed G3 and Stage B and removed their active edge.
   The subsequent rebooking promoted item 39 as the sole preferred `Eligible`
   candidate. Feature 031 and PRs #260 through #262 then completed G4. The
   current series successor archives G4, removes its binding edge to item 7,
   and carries the advisory edge from item 39 directly to item 7. This status
   grants no authority to start, release, or deliver any target. Item 7 and item
...
auf aktivem Manifestplatz 1. Nach dem G4-Abschluss führt seine beratende Kante
direkt zu Position 7. TuiVision gehört zum Scope; seine
...
it to active manifest position 1. After G4 completion, its advisory edge leads
directly to item 7. TuiVision is in scope while its ten
...
|---:|---|---|---|---|
| 39 | Eligible | [Lastenheft_Verlinkte-Abarbeitungsreihenfolgen-und-Spec-Kit-Feature-Nachweise.md](Lastenheft_Verlinkte-Abarbeitungsreihenfolgen-und-Spec-Kit-Feature-Nachweise.032-linked-intake-evidence.md) | — (Root / keine direkte Abhängigkeit) | — (kein Spec-Kit-Feature / no Spec Kit feature) |
| 7 | Pending | [Lastenheft_Secure-Development-Container-Hardening.md](Lastenheft_Secure-Development-Container-Hardening.md) | [Lastenheft_Verlinkte-Abarbeitungsreihenfolgen-und-Spec-Kit-Feature-Nachweise.md](Lastenheft_Verlinkte-Abarbeitungsreihenfolgen-und-Spec-Kit-Feature-Nachweise.032-linked-intake-evidence.md) → current (`PreferredSerialOrder`, binding: false) | — (kein Spec-Kit-Feature / no Spec Kit feature) |
| 8 | Blocked | [Lastenheft_Level-2-Sandbox-Anbindung-und-Haertungsvorbereitung.md](Lastenheft_Level-2-Sandbox-Anbindung-und-Haertungsvorbereitung.md) | [Lastenheft_Secure-Development-Container-Hardening.md](Lastenheft_Secure-Development-Container-Hardening.md) → current (`SandboxBaseline`, binding: true) | — (kein Spec-Kit-Feature / no Spec Kit feature) |
| 9 | Pending | [Lastenheft_CICD_Pipeline_Konfiguration.md](Lastenheft_CICD_Pipeline_Konfiguration.md) | — (Root / keine direkte Abhängigkeit) | — (kein Spec-Kit-Feature / no Spec Kit feature) |
| 10 | Pending | [Lastenheft_PowerShell_Cmdlets.md](Lastenheft_PowerShell_Cmdlets.md) | — (Root / keine direkte Abhängigkeit) | — (kein Spec-Kit-Feature / no Spec Kit feature) |
| 11 | Blocked | [Lastenheft_Script_Dokumentation.md](Lastenheft_Script_Dokumentation.md) | [Lastenheft_PowerShell_Cmdlets.md](Lastenheft_PowerShell_Cmdlets.md) → current (`DocumentationSurfaceBaseline`, binding: true) | — (kein Spec-Kit-Feature / no Spec Kit feature) |
| 12 | Blocked | [Lastenheft_Didactic-Script-and-Config-Comment-Hardening.md](Lastenheft_Didactic-Script-and-Config-Comment-Hardening.md) | [Lastenheft_CICD_Pipeline_Konfiguration.md](Lastenheft_CICD_Pipeline_Konfiguration.md) → current (`CommentSurfaceBaseline`, binding: true)<br>[Lastenheft_PowerShell_Cmdlets.md](Lastenheft_PowerShell_Cmdlets.md) → current (`CommentSurfaceBaseline`, binding: true)<br>[Lastenheft_Script_Dokumentation.md](Lastenheft_Script_Dokumentation.md) → current (`CommentSurfaceBaseline`, binding: true) | — (kein Spec-Kit-Feature / no Spec Kit feature) |
| 13 | Blocked | [Lastenheft_Script-and-Config-GSDB-Pruefung.md](Lastenheft_Script-and-Config-GSDB-Pruefung.md) | [Lastenheft_CICD_Pipeline_Konfiguration.md](Lastenheft_CICD_Pipeline_Konfiguration.md) → current (`FinalAuditInput`, binding: true)<br>[Lastenheft_PowerShell_Cmdlets.md](Lastenheft_PowerShell_Cmdlets.md) → current (`FinalAuditInput`, binding: true)<br>[Lastenheft_Script_Dokumentation.md](Lastenheft_Script_Dokumentation.md) → current (`FinalAuditInput`, binding: true)<br>[Lastenheft_Didactic-Script-and-Config-Comment-Hardening.md](Lastenheft_Didactic-Script-and-Config-Comment-Hardening.md) → current (`FinalAuditInput`, binding: true) | — (kein Spec-Kit-Feature / no Spec Kit feature) |
| 14 | Blocked | [Lastenheft_Secure-Development-RL-CL-Preset-Gap-Audit.md](Lastenheft_Secure-Development-RL-CL-Preset-Gap-Audit.md) | [Lastenheft_Script-and-Config-GSDB-Pruefung.md](Lastenheft_Script-and-Config-GSDB-Pruefung.md) → current (`FinalAuditInput`, binding: true) | — (kein Spec-Kit-Feature / no Spec Kit feature) |
| 15 | Blocked | [Lastenheft_Preset-Secure-Development-Assurance-Governance.md](Lastenheft_Preset-Secure-Development-Assurance-Governance.md) | [Lastenheft_Secure-Development-RL-CL-Preset-Gap-Audit.md](Lastenheft_Secure-Development-RL-CL-Preset-Gap-Audit.md) → current (`AssessmentBaseline`, binding: true) | — (kein Spec-Kit-Feature / no Spec Kit feature) |
| 16 | Blocked | [Lastenheft_Secure-Development-Baseline-3.3-Synchronisierung.md](Lastenheft_Secure-Development-Baseline-3.3-Synchronisierung.md) | [Lastenheft_Secure-Development-RL-CL-Preset-Gap-Audit.md](Lastenheft_Secure-Development-RL-CL-Preset-Gap-Audit.md) → current (`AssessmentBaseline`, binding: true)<br>[Lastenheft_Preset-Secure-Development-Assurance-Governance.md](Lastenheft_Preset-Secure-Development-Assurance-Governance.md) → current (`AssessmentBaseline`, binding: true) | — (kein Spec-Kit-Feature / no Spec Kit feature) |
| 17 | Blocked | [Lastenheft_ABSDD-Secure-Development-Assurance-Adoption.md](Lastenheft_ABSDD-Secure-Development-Assurance-Adoption.md) | [Lastenheft_Preset-Secure-Development-Assurance-Governance.md](Lastenheft_Preset-Secure-Development-Assurance-Governance.md) → current (`AssessmentBaseline`, binding: true)<br>[Lastenheft_Secure-Development-Baseline-3.3-Synchronisierung.md](Lastenheft_Secure-Development-Baseline-3.3-Synchronisierung.md) → current (`AssessmentBaseline`, binding: true) | — (kein Spec-Kit-Feature / no Spec Kit feature) |
| 18 | Blocked | [Lastenheft_KDM-KITSM-Lernreihen-Gap-Audit.md](Lastenheft_KDM-KITSM-Lernreihen-Gap-Audit.md) | [Lastenheft_ABSDD-Secure-Development-Assurance-Adoption.md](Lastenheft_ABSDD-Secure-Development-Assurance-Adoption.md) → current (`SecureDevelopmentBaseline`, binding: true) | — (kein Spec-Kit-Feature / no Spec Kit feature) |
| 19 | Blocked | [Lastenheft_KDM-KITSM-Lernarchitektur-und-Kompetenzmodell.md](Lastenheft_KDM-KITSM-Lernarchitektur-und-Kompetenzmodell.md) | [Lastenheft_KDM-KITSM-Lernreihen-Gap-Audit.md](Lastenheft_KDM-KITSM-Lernreihen-Gap-Audit.md) → current (`AssessmentBaseline`, binding: true) | — (kein Spec-Kit-Feature / no Spec Kit feature) |
| 20 | Blocked | [Lastenheft_KDM-KITSM-Jahr1-Retrofit.md](Lastenheft_KDM-KITSM-Jahr1-Retrofit.md) | [Lastenheft_KDM-KITSM-Lernarchitektur-und-Kompetenzmodell.md](Lastenheft_KDM-KITSM-Lernarchitektur-und-Kompetenzmodell.md) → current (`RequirementsGovernanceGate`, binding: true) | — (kein Spec-Kit-Feature / no Spec Kit feature) |
| 21 | Blocked | [Lastenheft_KDM-KITSM-Kaufmaennischer-Kern-Jahr2.md](Lastenheft_KDM-KITSM-Kaufmaennischer-Kern-Jahr2.md) | [Lastenheft_KDM-KITSM-Jahr1-Retrofit.md](Lastenheft_KDM-KITSM-Jahr1-Retrofit.md) → current (`RequirementsGovernanceGate`, binding: true) | — (kein Spec-Kit-Feature / no Spec Kit feature) |
| 22 | Blocked | [Lastenheft_KITSM-Professional-Jahr3.md](Lastenheft_KITSM-Professional-Jahr3.md) | [Lastenheft_KDM-KITSM-Kaufmaennischer-Kern-Jahr2.md](Lastenheft_KDM-KITSM-Kaufmaennischer-Kern-Jahr2.md) → current (`RequirementsGovernanceGate`, binding: true) | — (kein Spec-Kit-Feature / no Spec Kit feature) |
| 23 | Blocked | [Lastenheft_KDM-Professional-Jahr3.md](Lastenheft_KDM-Professional-Jahr3.md) | [Lastenheft_KITSM-Professional-Jahr3.md](Lastenheft_KITSM-Professional-Jahr3.md) → current (`HardCompletionGate`, binding: true) | — (kein Spec-Kit-Feature / no Spec Kit feature) |
| 24 | Blocked | [Lastenheft_KDM-KITSM-CSharp-Lernreihen-Rollout.md](Lastenheft_KDM-KITSM-CSharp-Lernreihen-Rollout.md) | [Lastenheft_KDM-Professional-Jahr3.md](Lastenheft_KDM-Professional-Jahr3.md) → current (`DocumentationSurfaceBaseline`, binding: true) | — (kein Spec-Kit-Feature / no Spec Kit feature) |
| 25 | Blocked | [Lastenheft_KDM-KITSM-Lernreihen-Closure.md](Lastenheft_KDM-KITSM-Lernreihen-Closure.md) | [Lastenheft_KDM-KITSM-CSharp-Lernreihen-Rollout.md](Lastenheft_KDM-KITSM-CSharp-Lernreihen-Rollout.md) → current (`FinalAuditInput`, binding: true) | — (kein Spec-Kit-Feature / no Spec Kit feature) |
| 26 | Blocked | [Lastenheft_ITSE-Lernreihen-Gap-Audit.md](Lastenheft_ITSE-Lernreihen-Gap-Audit.md) | [Lastenheft_KDM-KITSM-Lernreihen-Closure.md](Lastenheft_KDM-KITSM-Lernreihen-Closure.md) → current (`FinalAuditInput`, binding: true) | — (kein Spec-Kit-Feature / no Spec Kit feature) |
| 27 | Blocked | [Lastenheft_ITSE-Lernarchitektur-und-Kompetenzmodell.md](Lastenheft_ITSE-Lernarchitektur-und-Kompetenzmodell.md) | [Lastenheft_ITSE-Lernreihen-Gap-Audit.md](Lastenheft_ITSE-Lernreihen-Gap-Audit.md) → current (`AssessmentBaseline`, binding: true) | — (kein Spec-Kit-Feature / no Spec Kit feature) |
| 28 | Blocked | [Lastenheft_ITSE-Jahr1-Retrofit.md](Lastenheft_ITSE-Jahr1-Retrofit.md) | [Lastenheft_ITSE-Lernarchitektur-und-Kompetenzmodell.md](Lastenheft_ITSE-Lernarchitektur-und-Kompetenzmodell.md) → current (`RequirementsGovernanceGate`, binding: true) | — (kein Spec-Kit-Feature / no Spec Kit feature) |
| 29 | Blocked | [Lastenheft_ITSE-Technischer-Kern-Jahr2.md](Lastenheft_ITSE-Technischer-Kern-Jahr2.md) | [Lastenheft_ITSE-Jahr1-Retrofit.md](Lastenheft_ITSE-Jahr1-Retrofit.md) → current (`HardCompletionGate`, binding: true) | — (kein Spec-Kit-Feature / no Spec Kit feature) |
| 30 | Blocked | [Lastenheft_ITSE-Professional-Jahr3.md](Lastenheft_ITSE-Professional-Jahr3.md) | [Lastenheft_ITSE-Technischer-Kern-Jahr2.md](Lastenheft_ITSE-Technischer-Kern-Jahr2.md) → current (`HardCompletionGate`, binding: true) | — (kein Spec-Kit-Feature / no Spec Kit feature) |
| 31 | Blocked | [Lastenheft_ITSE-CSharp-Lernreihen-Rollout.md](Lastenheft_ITSE-CSharp-Lernreihen-Rollout.md) | [Lastenheft_ITSE-Professional-Jahr3.md](Lastenheft_ITSE-Professional-Jahr3.md) → current (`DocumentationSurfaceBaseline`, binding: true) | — (kein Spec-Kit-Feature / no Spec Kit feature) |
| 32 | Blocked | [Lastenheft_ITSE-Lernreihen-Closure.md](Lastenheft_ITSE-Lernreihen-Closure.md) | [Lastenheft_ITSE-CSharp-Lernreihen-Rollout.md](Lastenheft_ITSE-CSharp-Lernreihen-Rollout.md) → current (`FinalAuditInput`, binding: true) | — (kein Spec-Kit-Feature / no Spec Kit feature) |
| 33 | Blocked | [Lastenheft_Lernreihen-Konsistenz-und-KI-Kompetenz-Gap-Audit.md](Lastenheft_Lernreihen-Konsistenz-und-KI-Kompetenz-Gap-Audit.md) | [Lastenheft_ITSE-Lernreihen-Closure.md](Lastenheft_ITSE-Lernreihen-Closure.md) → current (`FinalAuditInput`, binding: true) | — (kein Spec-Kit-Feature / no Spec Kit feature) |
| 34 | Blocked | [Lastenheft_Preset-Intake-Review-Drei-Ebenen-Konsistenz.md](Lastenheft_Preset-Intake-Review-Drei-Ebenen-Konsistenz.md) | [Lastenheft_Lernreihen-Konsistenz-und-KI-Kompetenz-Gap-Audit.md](Lastenheft_Lernreihen-Konsistenz-und-KI-Kompetenz-Gap-Audit.md) → current (`AssessmentBaseline`, binding: true) | — (kein Spec-Kit-Feature / no Spec Kit feature) |
| 35 | Blocked | [Lastenheft_Preset-Learning-Series-Governance.md](Lastenheft_Preset-Learning-Series-Governance.md) | [Lastenheft_Preset-Intake-Review-Drei-Ebenen-Konsistenz.md](Lastenheft_Preset-Intake-Review-Drei-Ebenen-Konsistenz.md) → current (`RequirementsGovernanceGate`, binding: true) | — (kein Spec-Kit-Feature / no Spec Kit feature) |
| 36 | Blocked | [Lastenheft_Learning-Series-Governance-IHK-Pilot.md](Lastenheft_Learning-Series-Governance-IHK-Pilot.md) | [Lastenheft_Preset-Learning-Series-Governance.md](Lastenheft_Preset-Learning-Series-Governance.md) → current (`PublishedPresetBaseline`, binding: true) | — (kein Spec-Kit-Feature / no Spec Kit feature) |
| 37 | Blocked | [Lastenheft_Lernreihen-Gesamtkonsistenz-Closure.md](Lastenheft_Lernreihen-Gesamtkonsistenz-Closure.md) | [Lastenheft_Learning-Series-Governance-IHK-Pilot.md](Lastenheft_Learning-Series-Governance-IHK-Pilot.md) → current (`FinalAuditInput`, binding: true) | — (kein Spec-Kit-Feature / no Spec Kit feature) |
| 38 | Pending | [Lastenheft_Level-0-Checkout-und-Public-Template-Erstellung.md](Lastenheft_Level-0-Checkout-und-Public-Template-Erstellung.md) | [Lastenheft_Lernreihen-Gesamtkonsistenz-Closure.md](Lastenheft_Lernreihen-Gesamtkonsistenz-Closure.md) → current (`PreferredSerialOrder`, binding: false) | — (kein Spec-Kit-Feature / no Spec Kit feature) |
