...
Version `0.2.0` is validated with:
...
- the Home Baseline 13-target, 6-root, 15-edge series as read-only
  `LegacyAdoption` evidence;
- optional eleven-preset composition and one-command-per-surface checks;
- a versioned release ZIP and SHA-256 smoke test.

Local package validation on 2026-07-25 passed PSScriptAnalyzer across 114
