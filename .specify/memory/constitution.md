...
Modified principles:
- Level-2 Project Environment Registry (add SysInfoTool2/3/4 and SecureCaseTracker language repos)
Added sections:
- None
Removed sections:
- None
...
| `RiderProjects/SysInfoTool2` | .NET / C# cross-platform system-information CLI prototype with a dedicated test project | `dotnet restore/build/test SysInfoTool2.sln`; expand coverage gates as the CLI surface stabilizes | CLI output, generated docs, localization text, and templates remain text-first and WCAG 2.2 AA-oriented where applicable | Manual conservative `80`; C#/.NET Thorsten-Solo `125` unless the repo documents a justified deviation | `AGENTS.md`, `CLAUDE.md`, `GEMINI.md`, `.github/copilot-instructions.md`, `.opencode/command/`, Spec-Kit surfaces |
| `RiderProjects/SysInfoTool3` | .NET / C# system-information CLI iteration | `dotnet restore/build SysInfoTool3.sln`; add `dotnet test` once test projects are present | CLI output, generated docs, localization text, and templates remain text-first and WCAG 2.2 AA-oriented where applicable | Manual conservative `80`; C#/.NET Thorsten-Solo `125` unless the repo documents a justified deviation | `AGENTS.md`, `CLAUDE.md`, `GEMINI.md`, `.github/copilot-instructions.md`, `.opencode/command/`, Spec-Kit surfaces |
| `RiderProjects/SysInfoTool4` | .NET / C# system-information CLI iteration | `dotnet restore/build SysInfoTool4.sln`; add `dotnet test` once test projects are present | CLI output, generated docs, localization text, and templates remain text-first and WCAG 2.2 AA-oriented where applicable | Manual conservative `80`; C#/.NET Thorsten-Solo `125` unless the repo documents a justified deviation | `AGENTS.md`, `CLAUDE.md`, `GEMINI.md`, `.github/copilot-instructions.md`, `.opencode/command/`, Spec-Kit surfaces |
